...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Tue Mar 20 05:28:39 2012
# Project:  hw1.pro
# Template: app
...
SOURCES       = main.cpp \
		glwidget.cpp \
		qlobject.cpp \
		flagobject.cpp moc_glwidget.cpp \
		moc_qlobject.cpp \
		moc_flagobject.cpp
OBJECTS       = main.o \
		glwidget.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hw11.0.0/ && $(COPY_FILE) --parents glwidget.h qlobject.h flagobject.h .tmp/hw11.0.0/ && $(COPY_FILE) --parents main.cpp glwidget.cpp qlobject.cpp flagobject.cpp .tmp/hw11.0.0/ && (cd `dirname .tmp/hw11.0.0` && $(TAR) hw11.0.0.tar hw11.0.0 && $(COMPRESS) hw11.0.0.tar) && $(MOVE) `dirname .tmp/hw11.0.0`/hw11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hw11.0.0
...
compiler_moc_header_make_all: moc_glwidget.cpp moc_qlobject.cpp moc_flagobject.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_glwidget.cpp moc_qlobject.cpp moc_flagobject.cpp
